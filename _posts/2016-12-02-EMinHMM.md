---
layout: post
title: Expectation-Maximization in HMM
description: "Expectation-Maximization in HMM"
headline: "EM in HMM"
categories: ASR
tags: 
 -ASR
...
- Maximization: 현재의 Expectation, 즉 align 정보를 fix 해 놓고, 각 phone의 hmm의 내부 확률 (transition & observation)을 Baum-Welch방법을 써서 update 함. 
- 예를 들어, 코퍼스 전체에서 /a/ state 평균 길이 정보를 transition 확률로 spectral 정보의 분포(GMM)를 observation 확률로 update 함.
